...
import edu.uncc.aside.phpcodeannotate.visitors.AddModelVisitor;
import edu.uncc.aside.phpcodeannotate.visitors.IModelVisitor;
import edu.uncc.aside.phpcodeannotate.visitors.RemoveModelVisitor;
...
public class Path extends Model {
	...
	private Set<ISourceModule> compilationUnitsOfInterest = new HashSet<ISourceModule>();
	...
	public String toString() {
		...
		if (startProperty == null) {
			startOffset = accessor.getNode().getStart();
		} else {
	...
	public Set<ISourceModule> getCompilationUnitsOfInterest() {
