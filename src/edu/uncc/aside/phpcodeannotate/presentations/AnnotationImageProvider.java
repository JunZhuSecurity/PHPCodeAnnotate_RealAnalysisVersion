...
public class AnnotationImageProvider implements IAnnotationImageProvider {
	...
	private final static String ANNOTATION_QUESTION = "PHPCodeAnnotate.annotationQuestionAnnotation";
	private final static String ANNOTATION_QUESTION_CHECKED = "PHPCodeAnnotate.annotationQuestionCheckedAnnotation";
	private final static String ANNOTATION_ANSWER = "PHPCodeAnnotate.annotationAnswerAnnotation";
	...
	public ImageDescriptor getImageDescriptor(String imageDescritporId) {
		...
		if (imageDescritporId.equals(ANNOTATION_QUESTION)) {
			...
			descriptor = Plugin.getImageDescriptor("uncc.jpeg");
		}
